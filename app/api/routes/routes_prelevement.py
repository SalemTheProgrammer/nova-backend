...
def _to_read(p: PrelevementMP) -> PrelevementRead:
    ...
    return PrelevementRead(
        ...
        nom_matiere=matiere.nom if matiere else None,
    ...
    return [
        {
            ...
            "nom_matiere": l.matiere_premiere.nom if l.matiere_premiere else "",
            "quantite_actuelle": float(l.quantite_actuelle),
            "unite": l.matiere_premiere.unite_stock.value if l.matiere_premiere else "kg",
